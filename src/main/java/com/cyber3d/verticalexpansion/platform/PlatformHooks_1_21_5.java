...
public final class PlatformHooks_1_21_5 implements PlatformHooks {
    ...
    @Override
    public void init() {
        LOGGER.info("Initializing VerticalExpansion for Minecraft 1.21.5+");
        registerOreProfiles();
        initializeWorldGen();
        initializeFeatures();
    ...
    private void initializeWorldGen() {
        LOGGER.debug("Initializing world generation system for 1.21.5+");
        WorldGenInitializer.initialize();
    }

    private void initializeFeatures() {
        LOGGER.debug("Initializing features for 1.21.5+");
